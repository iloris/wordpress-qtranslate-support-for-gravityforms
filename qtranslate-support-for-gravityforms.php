  ...
  if (isset($form['fields'])) {
    foreach ($form['fields'] as $id => $field) {
      ...
      if (is_array($field['inputs']) ) {
        foreach ($field['inputs'] as $idInput => $input) {
          if (isset($form['fields'][$id]['inputs'][$idInput]['customLabel'])) {
            unset($form['fields'][$id]['inputs'][$idInput]['customLabel']);
            $form['fields'][$id]['inputs'][$idInput]['customLabel'] = qtrans_useCurrentLanguageIfNotFoundUseDefaultLanguage($form['fields'][$id]['inputs'][$idInput]['customLabel']);
          }
          if (isset($form['fields'][$id]['inputs'][$idInput]['placeholder'])) {
            $form['fields'][$id]['inputs'][$idInput]['placeholder'] = qtrans_useCurrentLanguageIfNotFoundUseDefaultLanguage($form['fields'][$id]['inputs'][$idInput]['placeholder']);
          }
        }
      }
        ...
        if (isset($form['fields'][$id]['choices'])) {
          if (is_array($form['fields'][$id]['choices']) ) {
